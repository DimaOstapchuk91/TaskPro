...
const Header = () => {
  ...
  return (
    <header className='w-full px-6 py-4.5 bg-text-dark flex justify-between items-center'>
      ...
      <div className='w-full flex justify-end gap-3.5'>
        ...
        <div className='flex items-center gap-2'>
          ...
          >
            ...
            <span className='absolute -bottom-1 bg-label-green w-3 h-3 rounded-[4px] flex justify-center items-center'>
              <svg
                width='8'
                height='8'
                className='stroke-text-dark fill-text-dark'
